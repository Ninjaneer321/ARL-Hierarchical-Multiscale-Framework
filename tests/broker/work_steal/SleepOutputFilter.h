...
namespace arl {
  namespace hms {
    ...
    /**
     * @brief Class implementing sleep output filter.
     */
    class SleepOutputFilter : public OutputFilter {
    ...
    private:
      ...
      //
      SleepOutputFilter(const SleepOutputFilter &); // not implemented
      SleepOutputFilter & operator=(const SleepOutputFilter &); // not implemented
...
#include "SleepOutputFilter_t.cc"
