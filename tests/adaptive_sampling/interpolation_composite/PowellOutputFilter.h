...
namespace arl {
  namespace hms {
    ...
    /**
     * @brief Class implementing powell composite model output filter.
     */
    class PowellOutputFilter : public OutputFilter {
    ...
    private:
      ...
      //
      PowellOutputFilter(const PowellOutputFilter &); // not implemented
      PowellOutputFilter & operator=(const PowellOutputFilter &); // not implemented
...
#include "PowellOutputFilter_t.cc"
