//
// File:      StressOutputFilter.h
// Package    adaptive_sampling
//
// HMS Interpolation Databases.
//
#if !defined(adaptive_sampling_StressOutputFilter_h)
#define adaptive_sampling_StressOutputFilter_h
...
namespace arl {
  namespace hms {
     ...
     */
    class StressOutputFilter : public InterpolationDatabaseOutputFilter {
    ...
    public:
       ...
       * Constructor.
       *
       * @param youngsModulus For stress scaling.
       */
      StressOutputFilter(double youngsModulus);

      /**
       * Destructor.
       */
      virtual ~StressOutputFilter();
    ...
    private:
      ...
      //
      StressOutputFilter(const StressOutputFilter &); // not implemented
      StressOutputFilter & operator=(const StressOutputFilter &); // not implemented
    ...
    HMS_SHARED_PTR(StressOutputFilter);

  }
}

#include "StressOutputFilter_t.cc"

#endif // adaptive_sampling_StressOutputFilter_h
